...
public class Exercise03_13 {
    public static void main(String[] args) {
		...
		// Allow user to input their filing status
		System.out.print("Enter the filing status: ");
		int status = input.nextInt();
		
		// Allow user to input their taxable income
		System.out.print("Enter the taxable income: ");
		double income = input.nextDouble();
		
		// Base for tax outcome
		double tax = 0;
		...
		// Printing out the result rounded to the hundredths place
        System.out.println("Tax is " + (int)(tax * 100) / 100.0);
        
        // Closing the Scanner for good practice to prevent resource leaks
        input.close();
    }
}
